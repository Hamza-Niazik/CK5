...
class BulkUploadForm extends FormBase {
   ...
   */
  public function __construct(EntityTypeManagerInterface $entityTypeManager, FileRepositoryInterface $fileRepository, FileSystemInterface $fileSystem, LoggerChannelFactoryInterface $loggerChannelFactory) {
    $this->entityTypeManager = $entityTypeManager;
    $this->fileRepository = $fileRepository;
    $this->fileSystem = $fileSystem;
    $this->logger = $loggerChannelFactory->get('simple_media_bulk_upload');
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    if ($selectedMediaType) {
      ...
      $form['upload_container']['dropzone']['#description'] = $this->t('You can upload as many files as you like. Each file can be up to @max_size in size. The following file extensions are accepted: @extensions', $variables);
